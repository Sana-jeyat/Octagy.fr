          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Détail des heures, certifications et ROI par employé
              </p>
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-200">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Cartographie des compétences acquises par département
              </p>
              <button className="text-purple-600 hover:text-purple-700 text-sm font-semibold">
                Générer le rapport →
              </button>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Formez, financez, mesurez. Dashboard simple et reporting clair
              pour optimiser vos investissements formation.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-700 mb-2">
                  <strong>
                    Crédits de formation (iKNO) distribués aux employés.
                  </strong>
                </p>
                <p className="text-xs text-blue-600">
                  Chaque employé peut convertir ses iKNO en $KNO après avoir
                  validé son profil (KYC). Ce processus reste personnel et
                  individuel.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <nav className="flex space-x-8">
            {[
              ...
              ...(!hasSubscription
                ? [{ id: "plans", name: "Abonnement", icon: Building }]
                : []),
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                <button
                  onClick={async () => {
                    if (!newDeptName.trim())
                      return alert("Veuillez entrer un nom de département.");
                    setAdding(true);
                    try {

            ...
            <button
              onClick={() => {
                const redirectUri = encodeURIComponent(
                  `${process.env.NEXT_PUBLIC_APP_API_URL}/connect/apple/check`
                );
                window.location.href = `${process.env.NEXT_PUBLIC_APP_API_URL}/connect/apple?client=web&redirect_uri=${redirectUri}`;
              }}
              disabled={isLoading}
